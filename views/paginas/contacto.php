<main class="contenedor seccion">
    ...
    <form class="formulario" action="/contacto" method="POST">
        ...
        <fieldset>
            ...
            <input type="number" placeholder="Tu Precio o Presupuesto" id="presupuesto" name="precio" required>
        </fieldset>
        ...
        <input type="submit" value="Enviar" class="no-margin-bottom boton-verde">
    </form>
</main>